<%-- 
    ...
    Created on : 20/05/2018, 03:54:34 AM
    Author     : Diego
--%>
    ...
    <div class="container">
        <div class="row">
           <div class="cuerpo">
                ...
                <div class="btn-nuevo">
                    <a class="btn btn-primary" type="button" href="<%=request.getContextPath()%>/mantenimiento/personal/registrarCarrera.jsp">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a class="btn btn-primary" type="button" href="<%=request.getContextPath()%>/mantenimiento/personal/modificarCarrera.jsp">
